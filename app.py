...
def main():
    ...
    st.sidebar.image("https://cdn.vectorstock.com/i/1000v/21/43/nutrition-logo-design-icon-science-symbol-vector-30542143.jpg", width=100)
    ...
    if choice == "Home":
        ...
        with col2:
            st.image("https://cdn-icons-png.flaticon.com/512/4056/4056283.png", width=200)
